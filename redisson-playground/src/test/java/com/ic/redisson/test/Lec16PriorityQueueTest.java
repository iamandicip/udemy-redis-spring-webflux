...
import com.ic.redisson.test.assignment.Category;
import com.ic.redisson.test.assignment.PriorityQueue;
import com.ic.redisson.test.assignment.UserOrder;
...
public class Lec16PriorityQueueTest extends BaseTest {
    ...
    public void setupQueue() {
        RScoredSortedSetReactive<UserOrder> sortedSet = this.client.getScoredSortedSet("user:order:queue",
